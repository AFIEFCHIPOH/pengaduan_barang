...
<head>
    ...
    <title>PN-Situbondo</title>
    <link rel="shortcut icon" href="assets/img/pn.jpg">
    ...
    <style>
        body {
            background: url(assets/img/11.jpg) no-repeat fixed;
    ...
    <div align="center">
        ...
        <div align="center" style="width:320px;margin-top:5%;">
            <form method="post" class="well well-lg p-5" action="" style="-webkit-box-shadow: 0px 0px 20px #888888;">
                <img class="logo" src="assets/img/pn.jpg" alt="">
                <h4>Selamat Datang PN-SITUBONDO</h4>
                <br>
