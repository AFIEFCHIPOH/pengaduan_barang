...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">PN-SITUBONDO</div>
    </a>
    ...
    <?php if (isset($_SESSION['role'])) : ?>
            ...
            <li class="nav-item <?= isset($transaksi) ? 'active' : ''; ?>">
                ...
                <div id="transaksi" class="collapse <?= isset($transaksi) ? 'show' : ''; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?= isset($pinjam) ? 'active' : ''; ?>" href="?pinjam">Pengaduan</a>
                    </div>
                </div>
            </li>
        <?php endif; ?>
            ...
            <li class="nav-item <?= isset($master) ? 'active' : ''; ?>">
                ...
                <div id="master" class="collapse <?= isset($master) ? 'show' : ''; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?= isset($user) ? 'active' : ''; ?>" href="?user">user</a>
                    </div>
                </div>
            </li>
        <?php endif; ?>
        ...
        <?php if ($_SESSION['role'] == 'admin') : ?>
            <li class="nav-item <?= isset($inventaris) ? 'active' : ''; ?>">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#inventaris" aria-expanded="true" aria-controls="inventaris">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Sarpras</span>
                </a>
                <div id="inventaris" class="collapse <?= isset($inventaris) ? 'show' : ''; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
