...
function submit(x) {
    var idBarang = '';
    if (x == 'add') {
        $('#pinjamModal .modal-title').html('Tambah barang pengaduan');
        ...
        $('#pinjamModal .modal-title').html('Edit barang pengaduan');
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?=base_url();?>process/cetak_laporan_pinjam_today.php" target="_blank"
                ...
                <span class="text">Cetak pengaduan hari ini</span>
            </a>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="font-weight-bold <?= $row['status'] != 'selesai' ? 'text-danger' : 'text-success'; ?>"><?= $row['status'] != 'selesai' ? "DIADUKAN" : "KEMBALI"; ?></td>
        ...
        <div class="modal-content">
            <form action="<?=base_url();?>process/process_pinjam.php" method="post">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Barang pengaduan</h5>
