    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="#" class="btn btn-primary btn-icon-split btn-sm" data-toggle="modal"
                data-target="#barangmasukModal" onclick="submit('add', '<?= $_SESSION['id'] ?>')">
            ...
            <a href="<?= base_url(); ?>process/cetak_laporan_transaksi_barang_today.php?jenis_transaksi=masuk"
                ...
                <span class="text">Cetak barang masuk hari ini</span>
            </a>
        </div>
        <div class="card-body">
...
<!-- Modal Tambah barang_masuk -->
<div class="modal fade" id="barangmasukModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?= base_url(); ?>process/process_barang_masuk.php" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="jumlah">Jumlah</span><span class="text-danger">*</span></label>
